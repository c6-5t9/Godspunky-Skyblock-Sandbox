...
public class AtomsplitKatana implements ToolStatistics, MaterialFunction, Ability
{
    ...
    public String getLore() {
        return "Deal " + (Object)ChatColor.GREEN + "+250% " + (Object)ChatColor.GRAY + "damage to Endermen.";
    }
    ...
    public void onAbilityUse(final Player player, final SItem sItem) {
        ...
        FerocityCalculation.ONE_TYPE_FEROCITY_BONUS_ENDERMAN.put((Object)player.getUniqueId(), (Object)400);
        new BukkitRunnable() {
            public void run() {
    ...
    public String getAbilityDescription() {
        return "Gain " + (Object)ChatColor.RED + "+400\u2afd Ferocity " + (Object)ChatColor.GRAY + "against Endermen for " + (Object)ChatColor.GREEN + "4s.";
    }
