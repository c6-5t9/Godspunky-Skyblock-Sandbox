    ...
    public void onAbilityUse(final Player player1, final SItem sItem) {
        ...
        if ((int)ZSHash.Charges.get((Object)player1.getUniqueId()) > 0) {
            ...
            Repeater.DEFENSE_REPLACEMENT_MAP.put((Object)player1.getUniqueId(), (Object)new DefenseReplacement() {
                @Override
                public String getReplacement() {
                    return (Object)ChatColor.AQUA + "-" + cost + " Mana (" + (Object)ChatColor.GOLD + ZombieSword.this.getAbilityName() + (Object)ChatColor.AQUA + ")";
                }
            ...
            final double healamount = 144.0 + player1.getMaxHealth() * 5.0 / 100.0;
            ...
            for (final Entity e : player1.getNearbyEntities(7.0, 7.0, 7.0)) {
                if (e instanceof LivingEntity && e instanceof Player) {
                    ...
                    e.sendMessage("" + (Object)ChatColor.GREEN + (Object)ChatColor.BOLD + player1.getName() + " healed you for 48 health!");
                }
            }
        }
        else {
