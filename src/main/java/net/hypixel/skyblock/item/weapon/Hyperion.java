...
public class Hyperion implements ToolStatistics, MaterialFunction, Ability
{
    ...
    public String getLore() {
        return "Deals " + (Object)ChatColor.RED + "+50% " + (Object)ChatColor.GRAY + "damage to withers. Grants " + (Object)ChatColor.RED + "+1 Damage " + (Object)ChatColor.GRAY + "and" + (Object)ChatColor.AQUA + " +2 Intelligence " + (Object)ChatColor.GRAY + "per" + (Object)ChatColor.RED + " Catacombs " + (Object)ChatColor.GRAY + "level.";
    }
