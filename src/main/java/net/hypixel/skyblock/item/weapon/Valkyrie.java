...
public class Valkyrie implements ToolStatistics, MaterialFunction, Ability
{
    ...
    public String getLore() {
        return "Deals " + (Object)ChatColor.RED + "+50% " + (Object)ChatColor.GRAY + "damage to withers. Grants " + (Object)ChatColor.RED + "+1 Damage " + (Object)ChatColor.GRAY + "and" + (Object)ChatColor.GREEN + " +1" + (Object)ChatColor.RED + " \u2741 Strength " + (Object)ChatColor.GRAY + "per" + (Object)ChatColor.RED + " Catacombs " + (Object)ChatColor.GRAY + "level.";
    }
