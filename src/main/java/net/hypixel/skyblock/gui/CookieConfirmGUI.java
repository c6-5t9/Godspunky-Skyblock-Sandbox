...
public class CookieConfirmGUI extends GUI
{
    ...
    public void onOpen(final GUIOpenEvent e) {
        ...
        this.set(new GUIClickableItem() {
            ...
            public void run(final InventoryClickEvent e) {
                ...
                e.getWhoClicked().getInventory().setItem(CookieConfirmGUI.this.cookieSlot, (ItemStack)null);
            ...
            public ItemStack getItem() {
                if (PlayerUtils.getCookieDurationTicks(player) <= 0L) {
                    return SUtil.enchant(SUtil.getStack((Object)ChatColor.YELLOW + "Consume Cookie", Material.COOKIE, (short)0, 1, Sputnik.trans("&7Gain the &dCookie Buff&7!"), "", Sputnik.trans("&7Duration: &b2 days&7!"), "", Sputnik.trans("&7Duration after: &b" + SUtil.getFormattedTimeToDay(3456000L))));
                }
                return SUtil.enchant(SUtil.getStack((Object)ChatColor.YELLOW + "Consume Cookie", Material.COOKIE, (short)0, 1, Sputnik.trans("&7Adds &b2 &7days to your"), Sputnik.trans("&dCookie Buff&7!"), "", Sputnik.trans("&7Duration after: &b" + SUtil.getFormattedTimeToDay(PlayerUtils.getCookieDurationTicks(player) + 3456000L))));
            }
        ...
        this.set(new GUIClickableItem() {
            ...
            @Override
            public ItemStack getItem() {
                return SUtil.getStack((Object)ChatColor.RED + "Cancel", Material.STAINED_CLAY, (short)14, 1, Sputnik.trans("&7I'm not hungry..."));
            }
    ...
    public void sendError(final Player p) {
        p.closeInventory();
        p.sendMessage((Object)ChatColor.RED + "An unexpected error occured while consuming this Booster Cookie! Contact server staff if this happends again.");
    }
