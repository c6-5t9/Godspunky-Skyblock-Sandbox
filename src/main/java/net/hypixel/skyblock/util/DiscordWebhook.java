...
public class DiscordWebhook
{
    ...
    public DiscordWebhook(final String url) {
        this.embeds = (List<EmbedObject>)new ArrayList();
        this.url = url;
    }
    
    public void addEmbed(final EmbedObject embed) {
        this.embeds.add((Object)embed);
    }
    ...
    public void execute() throws IOException {
        ...
        if (!this.embeds.isEmpty()) {
            final List<JSONObject> embedObjects = (List<JSONObject>)new ArrayList();
            for (final EmbedObject embed : this.embeds) {
                ...
                final List<JSONObject> jsonFields = (List<JSONObject>)new ArrayList();
                ...
                embedObjects.add((Object)jsonEmbed);
            }
    ...
    public static class EmbedObject
    {
        ...
        public EmbedObject() {
            this.fields = (List<Field>)new ArrayList();
        }
        ...
        public EmbedObject addField(final String name, final String value, final boolean inline) {
            this.fields.add((Object)new Field(name, value, inline));
            return this;
        }
    ...
    private class JSONObject
    {
        ...
        private JSONObject() {
            this.map = (HashMap<String, Object>)new HashMap();
        }
        ...
        public String toString() {
            ...
            final Set<Map.Entry<String, Object>> entrySet = (Set<Map.Entry<String, Object>>)this.map.entrySet();
            builder.append("{");
            int i = 0;
            for (final Map.Entry<String, Object> entry : entrySet) {
                ...
                if (val instanceof String) {
                    ...
                    builder.append((Object)Integer.valueOf(String.valueOf(val)));
                }
