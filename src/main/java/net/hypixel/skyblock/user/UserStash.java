...
public class UserStash
{
    ...
    public void addItemInStash(final ItemStack i) {
        final List<ItemStack> modifiableList = (List<ItemStack>)new ArrayList((Collection)this.u.getStashedItems());
        modifiableList.add((Object)i);
    ...
    public void pickUpStash() {
        ...
        for (final ItemStack i : this.u.getStashedItems()) {
            ...
            picked += i.getAmount();
            final List<ItemStack> modifiableList = (List<ItemStack>)new ArrayList((Collection)this.u.getStashedItems());
            modifiableList.remove((Object)i);
            this.u.setStashedItems(modifiableList);
            if (i.getAmount() < 2) {
